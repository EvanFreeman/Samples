...
(function (window) {
    ...
    var LayoutManager = Backbone.View.extend({
        ...
        setView: function (name, view, append) {
            var isViewAFunc = (typeof view === "function");
            ...
            //if the view is a function execute it and hope for the best.
            if (isViewAFunc) {
                view = view.call();
            }
            ...
            if (!manager) {
                throw new Error("Please set `View#manage` property with selector '" + name + "' to `true`.");
            }
